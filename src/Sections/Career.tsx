  ...
  return (
    <>
      ...
      >
        ...
        >
          <img className={styles.eyecLogo} src="EyeC.png" alt="EyeC logo"></img>
      ...
      >
        ...
        >
          ...
          <Typography sx={{ fontSize: "1rem", marginTop: "3%" }}>UX</Typography>
          <Typography sx={{ fontSize: "1rem", marginTop: "3%" }}>UI</Typography>
